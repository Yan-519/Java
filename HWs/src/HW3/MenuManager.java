...
//import HW3.Utils.InputManager.NumberSign;
//
...
//						
//						try {
//							deliveryDataBase.changeRestaurantStatus(rest.getCode());
...
//
//				try {
//					MessageBox.Info("New code", deliveryDataBase.addOrder(restaurant.getCode(), customer.getCode(), basePrice, InputManager.createDate()));
//				} catch (Exception e) {
//					MessageBox.error(e);
//				} 
//				break;
...
//				try {
//					orders = deliveryDataBase.filterOrdersBuyStatus(deliveryDataBase.getOrdersOfRestAdmin(restAdmin.getCode()), OrderStatus.Created);
//				} catch (Exception e) {
//					MessageBox.error(e);
//					break;
//				} 
...
//				try {
//					deliveryDataBase.setBalanceToCustomer(customer.getCode(), newAdd);
...
//				try {
//					deliveryDataBase.setBalanceToCustomer(customer.getCode(), newSub);
